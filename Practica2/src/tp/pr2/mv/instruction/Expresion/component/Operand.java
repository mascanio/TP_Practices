...
import tp.pr2.mv.instruction.Expresion.Parentesis;
import tp.pr2.mv.instruction.Expresion.Result;
import tp.pr2.mv.instruction.Expresion.component.operator.Operator;
...
public class Operand extends Component {
	...
	public Operand(String s) {
		...
		this.operand = Parentesis.ignoreParentesis(s).replaceAll(" ", "");
