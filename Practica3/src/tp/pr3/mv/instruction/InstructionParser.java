...
import tp.pr3.mv.instruction.Arithmetics.*;
import tp.pr3.mv.instruction.BooleanCond.*;
import tp.pr3.mv.instruction.Jumps.*;
import tp.pr3.mv.instruction.NumericCond.*;
import tp.pr3.mv.instruction.RestSeq.*;
