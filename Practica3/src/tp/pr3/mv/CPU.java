...
import tp.pr3.mv.input.InMethod;
...
import tp.pr3.mv.output.OutMethod;
...
public class CPU {
	...
	public void checkIfComputationIsAborted() throws CpuPCOverflowException,
		...
		if (!this.correctPc || this.getCurrentInsrtuction() == null)
	...
	public void increaseProgramCounter() {
		this.programCounter++;
		if (this.programCounter > this.program.getSizeProgram() || this.programCounter < 0) {
